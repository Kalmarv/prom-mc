  ...
  return (
    <>
      <div className='flex flex-col w-full'>
        <PromBarGraph query='sum(blocks_mined) by (player)' label='Blocks Mined' suffix='Blocks' />
        <PromBarGraph
        ...
        <PromBarGraph
          ...
          suffix='Blocks'
        />
        <PromBarGraph query='sum(damage_dealt) by (player)' label='Damage Dealt' suffix='Damage' />
        <PromBarGraph query='sum(damage_taken) by (player)' label='Damage Taken' suffix='Damage' />
        <PromBarGraph query='sum(entities_killed) by (player)' label='Mobs Killed' suffix='Mobs' />
